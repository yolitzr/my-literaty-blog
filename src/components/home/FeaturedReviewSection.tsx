...
function imgUrl(
	img: {
		url: string;
		formats?: { medium?: { url: string }; small?: { url: string } } | null;
	} | null,
): string | null {
	if (!img) return null;
		...
		<section className={styles.section}>
			<div className="container">
				<div className={styles.outerGrid}>
							...
							<div className={styles.reviewLayout}>
								...
								<div className={styles.reviewContent}>
									{review && book ? (
										...
										<>
											<p className={styles.excerpt}>
												Próximamente la primera reseña destacada...
											</p>
											<Link href="/book-review" className={styles.reviewBtn}>
					...
					{/* ── RIGHT: ¡Hola, soy Yolit! ── */}
					<div className={styles.rightCol}>
						<div className={styles.aboutCard}>
							<p className={styles.aboutLabel}>¡Hola! Soy Yolit</p>
							<div className={styles.photoSection}>
								...
								<img
									...
									alt=""
									aria-hidden="true"
									className={`${styles.leafDecor} ${styles.leafLeft}`}
								/>
								...
								<img
									...
									alt=""
									aria-hidden="true"
									className={`${styles.leafDecor} ${styles.leafRight}`}
								/>
							</div>
							<div className={styles.aboutBody}>
								<p className={styles.aboutBio}>
									{aboutSnippet ??
										'Lectora apasionada, amante de los libros en español e inglés. Aquí comparto mis lecturas, opiniones y recomendaciones con toda honestidad.'}
								</p>
							</div>
