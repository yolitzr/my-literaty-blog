...
import { FaInstagram, FaTiktok, FaPinterestP, FaChevronDown } from "react-icons/fa6";
      ...
      <div className={styles.topBar}>
        ...
        <Link href="/" className={styles.logoLink}>
          <span className={styles.siteLogo}>
            <span className={styles.logoBrand}>Yolit&apos;s</span>
            <span className={styles.logoMiddle}>
              <span className={styles.logoLine} />
              <BookLogo size={34} />
              <span className={styles.logoLine} />
            </span>
            <span className={styles.logoSub}>Bookish Blog</span>
          </span>
        </Link>
      ...
      <nav className={styles.navBar}>
        <div className={styles.navInner}>
          ...
          <ul className={`${styles.navList} ${menuOpen ? styles.navOpen : ""}`}>
            ...
            <li>
              <Link href="/about-me" onClick={() => setMenuOpen(false)}>Sobre Mí</Link>
            </li>
            ...
            >
              ...
              >
                Categorías
                <FaChevronDown className={`${styles.chevron} ${categoriesOpen ? styles.chevronOpen : ""}`} />
              </button>
              {categoriesOpen && (
            ...
            <li>
              <Link href="/tbr" onClick={() => setMenuOpen(false)}>Biblioteca</Link>
            </li>
            <li>
              <Link href="/authors" onClick={() => setMenuOpen(false)}>Recursos</Link>
            </li>
            <li>
              <Link href="/about-me#contacto" onClick={() => setMenuOpen(false)}>Contacto</Link>
            </li>
          </ul>
