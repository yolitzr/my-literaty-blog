...
function renderStars(stars) {
	...
	return <span className="fa-2x text-book-main">{indents}</span>;
}
...
const BookDetail = ({ book }) => {
	...
	return (
		...
		>
			<Hero
				bgHero={`${BASE_URL}${book?.image_main?.path}`}
					...
					<section className="grid lg:grid-cols-gridTwo lg:mt-12">
							...
							<div className="p-4 md:py-6 md:px-10">
								<article className="rounded-b-lg">
									{book?.review !== null ? (
										...
										<Tabs tabOne={book?.synopsis} tabNameOne="Synopsis" />
									)}
								</article>
								<div className="mt-8">
									<Image
							...
							<aside className="px-5 py-8 mt-4 info-author rounded-xl">
								...
								<div className="flex flex-col items-center justify-center px-6 py-4 mt-10 rounded-lg bg-book-lighter sm:mt-12 lg:mt-14 lg:flex-row">
									<div className="mt-4 md:w-2/5 md:mx-auto md:flex md:justify-center">
										<Image
											src={`${BASE_URL}${book?.author?.image?.path}`}
									...
									<div className="w-full mt-8 sm:ml-4">
										...
										<div className="flex items-center justify-center">
											{Object?.keys(book?.author?.social_networks)?.map(
												(social, idx) => (
													<a
													...
													>
														<i
															className={`${
																book?.author?.social_networks[social]?.icon
						...
						<div className="w-full p-6 mt-10 height-custom rounded-xl bg-book-light sm:flex sm:justify-center sm:mt-16 sm:rounded-xl lg:flex-col lg:justify-start lg:col-span-4 lg:ml-5 lg:mt-0 lg:bg-none">
							<div className="sm:flex-col sm:justify-center">
								<figure>
									<Image
										src={`${BASE_URL}${book?.image_main?.path}`}
										alt={book?.title}
										width={600}
										height={900}
										layout="responsive"
							...
							<div className="w-full mt-10 sm:mt-0 sm:flex sm:flex-col sm:justify-center sm:ml-5 lg:ml-0 lg:py-8 lg:px-4 lg:rounded-md lg:bg-book-light">
								<div className="mt-2 sm:mt-0">
									<div className="flex items-center">
										...
										<span className="ml-3 mr-2 font-semibold">ISBN:</span>
									...
									<div className="flex items-center">
										...
										<span className="ml-3 mr-2 font-semibold">Editorial:</span>
										<span className="text-base text-book-gray">
											{book?.editorial}
										</span>
									</div>
									<div className="flex items-center">
										...
										<span className="ml-3 mr-2 font-semibold">Serie:</span>
										<span className="text-base text-book-gray">
											{book?.serie}
										</span>
									</div>
									...
									<div className="flex items-center mt-1">
										...
										<span className="ml-3 mr-2 font-semibold">N. pages:</span>
										<span className="text-base text-book-gray">
											{book?.pages}
										</span>
									</div>
					...
					<section className="relative">
						...
						<div className="px-8 py-4 mt-10">
							<h5 className="font-semibold text-center text-book-dark">
								¡Dare to comment! Blogs feed on comment and I would be happy to
								read your opinion about this book. Please remember not to spam,
								so I won`t have to delete your comment. ¡I hope to read you
								soon!
							</h5>
							<div className="mt-10">
